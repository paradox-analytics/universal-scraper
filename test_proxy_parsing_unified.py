    ...
    test_cases = [
        {
            ...
            "config": {
                "provider": "brightdata",
                "externalProxy": {
                    "server": "brd.superproxy.io,33335,brd-customer-hl_803e8195-zone-web_unlocker1,t8mhp1qev1i1",
                    "username": "",
                    "password": ""
                }
            },
            "expected_server": "http://brd.superproxy.io:33335",
            "expected_user": "brd-customer-hl_803e8195-zone-web_unlocker1",
            "expected_pass": "t8mhp1qev1i1"
        },
        {
            ...
            "expected_user": "brd-customer-hl_803e8195-zone-web_unlocker1",
            "expected_pass": "t8mhp1qev1i1",
            "expected_api_key": "brd.superproxy.io:33335:brd-customer-hl_803e8195-zone-web_unlocker1:t8mhp1qev1i1"
        },
        {
