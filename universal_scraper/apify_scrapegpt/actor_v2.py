...
class UniversalScraperV2:
    ...
    def __init__(
        ...
        quality_mode: str = "balanced"  # NEW: DirectLLM quality mode
    ):
        ...
        self.llm_extractor = DirectLLMExtractor(
            api_key=api_key,
            quality_mode=quality_mode,  # NEW: Use Langchain transformer + quality mode
    ...
    if APIFY_AVAILABLE:
        async with Actor:
            ...
            if not api_key:
                ...
                # Push informational message to dataset if Actor is available
                try:
                    ...
                    pass  # If Actor not available (local testing), just log
            ...
            scraper = UniversalScraperV2(
                ...
                quality_mode=quality_mode  # NEW: DirectLLM quality mode
            )
