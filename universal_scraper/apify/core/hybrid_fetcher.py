...
class HybridFetcher:
 ...
 proxy_manager: Optional[Any] = None, # ProxyManager for rotation
 ...
 use_camoufox: bool = True, # Use Camoufox instead of Playwright (better anti-detection)
 web_unblocker_api_key: Optional[str] = None, # Bright Data Web Unblocker API key
 ...
 self.proxy_manager = proxy_manager # Store ProxyManager
 self.enable_cache = enable_cache
 self.cache_dir = cache_dir
 self.headless = headless
 self.browser_timeout = browser_timeout
 self.force_mode = force_mode
 self.use_camoufox = use_camoufox # Store Camoufox preference
 self.web_unblocker_api_key = web_unblocker_api_key # Web Unblocker API key
 self.web_unblocker_zone = web_unblocker_zone # Web Unblocker zone
 ...
 proxy_manager=self.proxy_manager, # Pass ProxyManager
 ...
 proxy_config=self.proxy_config,
 proxy_manager=self.proxy_manager, # Pass ProxyManager for rotation
