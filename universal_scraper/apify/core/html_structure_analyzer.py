"""
HTML Structure Analyzer - Inspired by direct LLM extraction's html_analyzer_node
...
class HTMLStructureAnalyzer:
 ...
 Inspired by direct LLM extraction's HTML Analyzer Node
 """
 ...
 # Build analysis prompt (inspired by direct LLM extraction)
