...
class FastPaginationDetector:
    ...
    def _extract_max_page(self, soup: BeautifulSoup, current_page: int) -> Optional[int]:
        ...
        if max_page:
            ...
            logger.warning(" Could not determine max_page from any strategy")
