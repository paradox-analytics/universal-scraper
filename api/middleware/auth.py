...
def get_firebase_public_keys():
    ...
    try:
        ...
        jwks_url = f"https://www.googleapis.com/robot/v1/metadata/x509/securetoken@system.gserviceaccount.com"
...
async def get_current_user(
    ...
    # Fallback: check Authorization header if it's not a Bearer token
        ...
        logger.debug(f"API key found in Authorization header (non-Bearer)")
